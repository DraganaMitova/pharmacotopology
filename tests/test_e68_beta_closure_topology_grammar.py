...
def test_e68_selects_beta_subtypes_and_abstains_on_open_beta_only() -> None:
    ...
    assert sandwich["operator_state_propagation_summary"]["final_state_summary"]["beta_sandwich_core"] > 0.0
    ...
    assert membrane_barrel["operator_state_propagation_summary"]["final_state_summary"]["membrane_beta_barrel"] > 0.0
