# V25 Fast Mechanism Evidence Sprint Commands
...
python3 -m pytest -q \
  ...
  tests/test_v25_fast_mechanism_evidence_sprint.py
```
...
python3 "$REPO_ROOT/scripts/print_v25_fast_mechanism_evidence_sprint_summary.py"
```

Expected high-level boundary:
