# V20 XCL1 State-Specific Evidence Readout Commands
...
python3 "$REPO_ROOT/scripts/print_v19_kcsa_membrane_pore_evidence_lock_summary.py"

bash "$REPO_ROOT/scripts/run_v20_xcl1_state_specific_evidence_readout.sh"
python3 "$REPO_ROOT/scripts/print_v20_xcl1_state_specific_evidence_summary.py"
```
