...
- `V58_24SW_2` selected `oligomerization_controlled_folding` expected `globular_closure` decision `abstain_recommended` bucket `globular_vs_interface_or_oligomer_ambiguity`
