...
LOCK_CERT="$REPO_ROOT/first_contact_clean_pharmacotopology_layer_run/V18_P53_PARTNER_INDUCED_EVIDENCE_LOCK/v18_p53_partner_induced_evidence_lock_certificate.json"
if [ ! -f "$V18_CERT" ]; then
...
python3 "$REPO_ROOT/scripts/run_v18b_p53_isolated_tad_abstain_context_v0.py" "$@"
