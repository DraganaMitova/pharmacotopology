...
OUT_DIR="${OUT_DIR:-$REPO_ROOT/first_contact_clean_pharmacotopology_layer_run/V13a_1UBQ_PURPOSE_GATE_READOUT}"
...
CHEMICAL_THRESHOLD="${CHEMICAL_THRESHOLD:-0.50}"
...
python3 "$REPO_ROOT/scripts/run_v13a_purpose_gate_readout_v0.py" \
  ...
  --chemical-threshold "$CHEMICAL_THRESHOLD"
