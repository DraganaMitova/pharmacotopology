...
def _controls(
    *,
    ...
    random_packet = build_sealed_simulation_packet(target_id="V68_RANDOM_SEQUENCE_CONTROL", target_name="V68 random sequence control", sequence=deterministic_random_sequence(128), sources=[], perturbations=[])
