...
cert = root / "first_contact_clean_pharmacotopology_layer_run" / "V13b_1CLL_ADAPTIVE_CHEMICAL_POLICY_READOUT" / "v13a_1ubq_purpose_gate_readout_certificate.json"
if not cert.exists():
    raise SystemExit(
        f"missing certificate: {cert}\n"
        "run: bash $REPO_ROOT/scripts/run_v13b_1cll_adaptive_chemical_policy_readout.sh"
    )
...
lock = o.get("claim_lock_check", {})

print("=== V13b 1CLL ADAPTIVE CHEMICAL POLICY READOUT ===")
...
print("topology_policy:", o.get("target_purpose", {}).get("topology_policy"))
...
print("dca_mean_effective_balanced_background:", sel.get("dca_mean_effective_balanced_background"))
print("dca_absolute_support_pass:", sel.get("dca_absolute_support_pass"))
print("dca_background_enrichment_ratio:", sel.get("dca_background_enrichment_ratio", sel.get("dca_enrichment_ratio")))
print("dca_background_enrichment_pass:", sel.get("dca_background_enrichment_pass"))
print("dca_pass_semantics:", sel.get("dca_pass_semantics"))
print("claim_lock_status:", lock.get("status"))
print("claim_lock_failed_checks:", lock.get("failed_checks"))
