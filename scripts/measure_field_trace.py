...
def field_projection_paths(run_dir: Path) -> List[Path]:
    candidates = [
        ...
        run_dir / "external_axis_repair_report.json",
        run_dir / "external_axis_repair_rows.csv",
        run_dir / "external_axis_repair_conflict_delta.csv",
        run_dir / "external_axis_repair_abstention_delta.csv",
        run_dir / "external_axis_repair_quarantine_rows.csv",
        run_dir / "external_axis_repair_family_summary.csv",
        run_dir / "external_axis_repair_dashboard.html",
        run_dir / "external_axis_repair_certificate.json",
        run_dir / "visual_mechanism_12_report.json",
        run_dir / "visual_mechanism_12_rows.csv",
        run_dir / "visual_mechanism_12_contact_metrics.csv",
        run_dir / "visual_mechanism_12_failure_cohorts.csv",
        run_dir / "visual_mechanism_12_dashboard.html",
        run_dir / "visual_mechanism_12_certificate.json",
        run_dir / "contact_topology_repair_12_report.json",
        run_dir / "contact_topology_repair_12_rows.csv",
        run_dir / "contact_topology_repair_12_gap_analysis.csv",
        run_dir / "contact_topology_repair_12_failure_cohorts.csv",
        run_dir / "contact_topology_repair_12_dashboard.html",
        run_dir / "contact_topology_repair_12_certificate.json",
        run_dir / "visual_mechanism_audit_report.json",
        run_dir / "visual_mechanism_audit_rows.csv",
        run_dir / "visual_mechanism_audit_overfit_risks.csv",
        run_dir / "visual_mechanism_audit_dashboard.html",
        run_dir / "visual_mechanism_audit_certificate.json",
        run_dir / "real_coordinate_visual_8_report.json",
        run_dir / "real_coordinate_visual_8_rows.csv",
        run_dir / "real_coordinate_visual_8_contact_metrics.csv",
        run_dir / "real_coordinate_visual_8_native_contact_summary.csv",
        run_dir / "real_coordinate_visual_8_dashboard.html",
        run_dir / "real_coordinate_visual_8_certificate.json",
        run_dir / "contact_law_threshold_report.json",
        run_dir / "contact_law_threshold_rows.csv",
        run_dir / "contact_law_threshold_grid.csv",
        run_dir / "contact_law_threshold_holdout.csv",
        run_dir / "contact_law_threshold_failures.csv",
        run_dir / "contact_law_threshold_dashboard.html",
        run_dir / "contact_law_threshold_certificate.json",
        run_dir / "folding_nucleus_closure_report.json",
        run_dir / "folding_nucleus_closure_events.csv",
        run_dir / "folding_nucleus_closure_trajectory.csv",
        run_dir / "folding_nucleus_closure_metrics.csv",
        run_dir / "folding_nucleus_closure_failures.csv",
        run_dir / "folding_nucleus_closure_dashboard.html",
        run_dir / "folding_nucleus_closure_certificate.json",
        run_dir / "competitive_nucleus_selection_report.json",
        run_dir / "competitive_nucleus_selection_selected_events.csv",
        run_dir / "competitive_nucleus_selection_rejections.csv",
        run_dir / "competitive_nucleus_selection_compatibility.csv",
        run_dir / "competitive_nucleus_selection_trajectory.csv",
        run_dir / "competitive_nucleus_selection_metrics.csv",
        run_dir / "competitive_nucleus_selection_dashboard.html",
        run_dir / "competitive_nucleus_selection_certificate.json",
        run_dir / "nucleus_graph_selectivity_report.json",
        run_dir / "nucleus_graph_selectivity_graphs.csv",
        run_dir / "nucleus_graph_selectivity_selected_events.csv",
        run_dir / "nucleus_graph_selectivity_rejections.csv",
        run_dir / "nucleus_graph_selectivity_decoys.csv",
        run_dir / "nucleus_graph_selectivity_rank_enrichment.csv",
        run_dir / "nucleus_graph_selectivity_metrics.csv",
        run_dir / "nucleus_graph_selectivity_dashboard.html",
        run_dir / "nucleus_graph_selectivity_certificate.json",
        run_dir / "physical_closure_state_report.json",
        run_dir / "physical_closure_state_states.csv",
        run_dir / "physical_closure_state_decoys.csv",
        run_dir / "physical_closure_state_rank_enrichment.csv",
        run_dir / "physical_closure_state_metrics.csv",
        run_dir / "physical_closure_state_dashboard.html",
        run_dir / "physical_closure_state_certificate.json",
        run_dir / "active_physical_selection_report.json",
        run_dir / "active_physical_selection_selectors.csv",
        run_dir / "active_physical_selection_selected_events.csv",
        run_dir / "active_physical_selection_ablation.csv",
        run_dir / "active_physical_selection_dashboard.html",
        run_dir / "active_physical_selection_certificate.json",
