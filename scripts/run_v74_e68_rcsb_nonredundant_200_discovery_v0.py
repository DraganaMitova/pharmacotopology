...
def _controls(
    *,
    ...
    random_packet = build_sealed_operator_state_packet(target_id="V74_RANDOM_SEQUENCE_CONTROL", target_name="V74 random sequence control", sequence=deterministic_random_sequence(128), sources=[], perturbations=[])
